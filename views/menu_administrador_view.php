...
<div class="container well">
    ...
    <div class="row">
        <p>
        <div class="span6"><a href="personal/control_alumnos/registrar_alumno" class="btn btn-block"><i class="icon-list-alt"></i> Control de Alumnos</a></div>
        <div class="span6"><a href="personal/control_personal/registrar_personal" class="btn btn-block"><i class="icon-list-alt"></i> Control de Personal</a></div>
        </p>
    </div>
    <!--div class="row">
        <p>

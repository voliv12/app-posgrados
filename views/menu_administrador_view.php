...
<div class="container well">
    <h4><a>Administración de Usuarios</a></h4>
    <div class="row">
        <p>
...
<div class="container well">
    <h4><a>Calendario</a></h4>
        <div class="row">
            <p>
                <div class="span6"><a href="calendar/calendario" class="btn btn-block"><i class="icon-list-alt"></i> Calendarización de Eventos</a></div>
